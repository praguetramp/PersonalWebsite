...
<body>
    ...
    ?>
    <div align="center"><strong>QQ好友查询结果</strong></div>
    <table width="90%" border="1" align="center">
        ...
        <tr>
            <td><div align="center"><?php echo $row->Qno;?></div></td>
            <td><div align="center"><?php echo $row->Qbeizhu;?></div></td>
            <td><div align="center"><?php echo $row->Qarea;?></div></td>
            <td><div align="center">
                <a href="qq_detail.php ?Qno=<?php echo $row->Qno;?>" target="_blank">详情</a>
                <a href="qq_update.php ?Qno=<?php echo $row->Qno;?>" target="_blank">修改</a>
                <a href="qq_delete.php ?Qno=<?php echo $row->Qno;?>" target="_blank">删除</a>
            </div></td>
        </tr>
        <?php 
        $i=$i+1;
    ...
    <div align="center">
        ...
        <?php 
        $href=$PHP_SELF."?myqq".urlencode($myqq);
        if($pageno<>1){ ?>
