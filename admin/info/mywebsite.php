...
<body>
    ...
    ?>
    <div align="center"><strong>我的收藏网站查询结果</strong></div>
    <table width="90%" border="1" align="center">
        ...
        <tr>
            <td><div align="center"><?php echo $row->furl;?></div></td>
            <td><div align="center"><?php echo $row->fbeizhu;?></div></td>
            <td><div align="center"><?php echo $row->ffenlei;?></div></td>
            <td><div align="center">
                <a href="qq_detail.php ?furl=<?php echo $row->furl;?>" target="_blank">详情</a>
                <a href="qq_update.php ?furl=<?php echo $row->furl;?>" target="_blank">修改</a>
                <a href="qq_delete.php ?furl=<?php echo $row->furl;?>" target="_blank">删除</a>
            </div></td>
        </tr>
        <?php 
        $i=$i+1;
    ...
    <div align="center">
        ...
        <?php 
        $href=$PHP_SELF."?mywebsite".urlencode($mywebsite);
        if($pageno<>1){ ?>
